...
export const testProxies = [
  { host: '0.0.0.0', country: 'Ukraine', city: 'Kyiv' },
  { host: '0.0.0.1', country: 'France', city: 'Paris' },
  { host: '0.0.0.2', country: 'Germany', city: 'Berlin' },
];

export const localStorageProp = 'custom_user_agents';
...
export const userAgentsList = [{
  ...
  name: 'Android 5.1.1 SHIELD Tablet',
  ua: 'Mozilla/5.0 (Linux; Android 5.1.1; SHIELD Tablet Build/LMY48C) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.98 Safari/537.36'
}, {
  name: 'Android 5.0.2 SAMSUNG SM-T550',
  ...
  name: 'Android 5.0.2 LG-V410/V41020c',
  ...
  name: 'Android 4.2.2 NEO-X5-116A',
  ...
  name: 'Dalvik Android 6.0.1 Nexus Player',
  ...
  name: 'Windows Phone 10.0 Xbox XboxOne',
